...
import {AlertTriangle, Clock, Globe, LogIn, LogOut, Monitor, Shield, Smartphone} from 'lucide-react';

interface SecurityEvent {
    id: string;
    type: 'login' | 'logout' | 'failed_login' | 'password_change' | 'session_expired';
    timestamp: Date;
    ipAddress: string;
    userAgent: string;
    location?: string;
                        ...
                        <div className="space-y-4">
                            {events.map((event) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`p-2 rounded-full bg-muted ${getEventColor(event)}`}>
