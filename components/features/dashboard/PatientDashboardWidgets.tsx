...
export function PatientDashboardWidgets() {
  ...
  const billing = [
    {
      description: "Consultation - Dr. Johnson",
      date: "Jan 15",
      amount: "$150",
      status: "Paid",
    },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">
              {wellness.steps.current.toLocaleString()}
            </p>
            <Progress value={wellness.steps.percentage} className="h-2 mt-2" />
            <p className="text-xs text-muted-foreground mt-1">
              Goal: {wellness.steps.goal.toLocaleString()}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">
              {wellness.heartRate.current} bpm
            </p>
          ...
          <CardContent className="space-y-3">
            {medications.map((med, idx) => (
              ...
              >
                <div
                  className={`mt-1 ${
                    med.taken ? "text-green-600" : "text-muted-foreground"
                  }`}
                >
          ...
          <CardContent className="space-y-3">
            {testResults.map((result, idx) => (
              ...
              >
                ...
                <Badge
                  variant={result.status === "Normal" ? "secondary" : "default"}
                >
                  {result.status}
                </Badge>
              </div>
