...
export function AppointmentSystem() {
  ...
  const upcomingAppointments = filteredAppointments.filter(
    (apt) => apt.date > new Date() && apt.date <= addDays(new Date(), 7)
  );
  ...
  const stats = {
    ...
    direct: todayAppointments.filter(
      (a) => a.type === "routine" || a.type === "surgery"
    ).length,
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        {apt.roomNumber && (
                          <Badge variant="outline">{apt.roomNumber}</Badge>
                        )}
                        <Button
                          variant="ghost"
                          size="sm"
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <Select
                value={formData.type}
                onValueChange={(val) =>
                  setFormData({ ...formData, type: val as Appointment["type"] })
                }
                disabled={isReadOnly}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(val) =>
                  setFormData({
                    ...formData,
                    priority: val as Appointment["priority"],
                  })
                }
                disabled={isReadOnly}
              >
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(val) =>
                  setFormData({
                    ...formData,
                    status: val as Appointment["status"],
                  })
                }
                disabled={isReadOnly}
              >
