...
export function HealthcareDashboard() {
  ...
  const mockDepartments = [
    { id: "1", name: "Cardiology", head: "Dr. John Smith", totalPatients: 45, activeStaff: 12, location: "Building A, Floor 2", phone: "+1-555-0201", status: "operational" },
    { id: "2", name: "Emergency", head: "Dr. Sarah Wilson", totalPatients: 23, activeStaff: 18, location: "Building B, Ground Floor", phone: "+1-555-0202", status: "operational" },
  ];
      ...
      {selectedView === "doctors" && user?.role !== "doctor" && features.roles.nurse && (
        <Card className="overflow-hidden">
          <CardHeader className="px-6 pt-6 pb-2">
            ...
            <CardDescription className="text-responsive">Complete directory of all medical professionals</CardDescription>
          </CardHeader>
          <CardContent className="p-0">
            <div className="table-responsive">
              <DoctorTable
      ...
      <DashboardTabs activeTab={activeTab} onTabChange={setActiveTab}>
        {user?.role !== "patient" && (
          <TabsContent value="dashboard" className="mt-4 sm:mt-6">
            <div className="spacing-responsive">
              {loading.stats ? <DashboardStatsSkeleton /> : <DashboardStats stats={statsData} loading={loading.stats} />}
