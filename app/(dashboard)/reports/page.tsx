...
export default function ReportsPage() {
    ...
    const reportCategories = [
        {
            ...
            reports: [
                ...
                {
                    name: 'Chronic Conditions Report',
                    description: 'Top conditions and treatment outcomes',
                    lastRun: '2024-01-12',
                    status: 'ready'
                },
            ]
        },
        {
            ...
            reports: [
                ...
                },
                {
                    ...
                    description: 'Claims processing and reimbursements',
                    lastRun: '2024-01-14',
                    status: 'processing'
                },
                {
                    name: 'Outstanding Payments',
                    description: 'Pending payments and collections',
                    lastRun: '2024-01-13',
                    status: 'ready'
                },
                {
                    name: 'Cost Analysis',
                    description: 'Operational costs and efficiency metrics',
                    lastRun: '2024-01-12',
                    status: 'ready'
                },
            ]
            ...
            reports: [
                {
                    ...
                    description: 'Success rates and patient recovery',
                    lastRun: '2024-01-15',
                    status: 'ready'
                },
                {
                    name: 'Lab Results Summary',
                    description: 'Test results and abnormal findings',
                    lastRun: '2024-01-14',
                    status: 'ready'
                },
                {
                    name: 'Medication Usage',
                    description: 'Prescription patterns and drug utilization',
                    lastRun: '2024-01-13',
                    status: 'ready'
                },
                {
                    name: 'Quality Metrics',
                    description: 'Clinical quality indicators and benchmarks',
                    lastRun: '2024-01-12',
                    status: 'ready'
                },
            ]
            ...
            reports: [
                {
                    ...
                    description: 'Employee productivity and efficiency',
                    lastRun: '2024-01-15',
                    status: 'ready'
                },
                {
                    name: 'Appointment Analytics',
                    description: 'Scheduling patterns and no-shows',
                    lastRun: '2024-01-14',
                    status: 'ready'
                },
                {
                    name: 'Resource Utilization',
                    description: 'Equipment and facility usage',
                    lastRun: '2024-01-13',
                    status: 'ready'
                },
                {
                    name: 'Wait Time Analysis',
                    description: 'Patient wait times and bottlenecks',
                    lastRun: '2024-01-12',
                    status: 'ready'
                },
            ]
    ...
    const recentReports = [
        {
            name: 'Patient Demographics Q4 2023',
            type: 'Patient Report',
                                            ...
                                            {category.reports.map((report, reportIndex) => (
                                                <div key={reportIndex}
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-xs text-muted-foreground mt-1">Last
                                                            run: {report.lastRun}</p>
                                                    </div>
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                <div className="flex space-x-1">
                                                    <Button size="sm" variant="outline">
                                                        {report.status === 'active' ? <Pause className="h-3 w-3"/> :
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                description: 'Detailed department metrics',
                                category: 'Operational',
                                usage: 32
                            },
                            {
                                name: 'Patient Safety Report',
                                description: 'Safety incidents and quality measures',
                                category: 'Quality',
                                usage: 28
                            },
                            {
                            ...
                            },
                            {
                                ...
                                description: 'Treatment success and patient outcomes',
                                category: 'Clinical',
                                usage: 36
                            },
                            {
                                name: 'Regulatory Compliance',
                                description: 'Compliance metrics and audit results',
                                category: 'Compliance',
                                usage: 19
                            },
                        ].map((template, index) => (
