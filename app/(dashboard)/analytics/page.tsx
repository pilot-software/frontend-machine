                            ...
                            <CardContent>
                                <ResponsiveContainer width="100%" height={300}>
                                    <AreaChart data={patientGrowthData}>
                                        ...
                                        <YAxis/>
                                        <Tooltip/>
                                        <Area type="monotone" dataKey="patients" stackId="1" stroke="#3b82f6"
                                              fill="#3b82f6" fillOpacity={0.6}/>
                                        <Area type="monotone" dataKey="newPatients" stackId="2" stroke="#10b981"
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                {[
                                    {
                                        type: 'success',
                                        message: 'Patient satisfaction target exceeded this month',
                                        icon: CheckCircle2
                                    },
                                    {
                                        type: 'warning',
                                        message: 'ICU capacity at 92% - consider overflow planning',
                                        icon: AlertTriangle
                                    },
                                    {type: 'info', message: 'Monthly quality report ready for review', icon: Activity},
                                    {
                                        type: 'success',
                                        message: 'Revenue target achieved 5 days early',
                                        icon: CheckCircle2
                                    },
                                ].map((alert, index) => {
