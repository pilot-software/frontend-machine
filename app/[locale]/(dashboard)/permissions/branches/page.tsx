    ...
    return (
        <div className="space-y-6">
                    ...
                    <DialogContent>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <Select value={newUserAccess.userId}
                            ...
                            <div>
                                ...
                                <Select value={newUserAccess.accessLevel}
                                        onValueChange={(value: any) => setNewUserAccess({
                                            ...newUserAccess,
                                            accessLevel: value
                                        })}>
                                    <SelectTrigger>
            ...
            <Tabs value={selectedBranch}
                  onValueChange={(value) => router.push(`/permissions/branches?branch=${value}`)}>
