...
export default function PermissionAuditPage() {
  ...
  const mockAuditLogs = [
    ...
    },
    {
      ...
      details:
        "Attempted to grant user deletion permission - insufficient privileges",
      status: "FAILED",
    },
  ];
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Select value={actionFilter} onValueChange={setActionFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="BRANCH_ACCESS_CHANGE">
                  Branch Access
                </SelectItem>
                <SelectItem value="GRANT_TEMPORARY_ROLE">
                  Temporary Role
                </SelectItem>
              </SelectContent>
            </Select>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            Permission Changes ({filteredLogs.length} entries)
          </CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <Badge
                            className={getTargetTypeBadge(log.targetType)}
                            variant="outline"
                          >
                            {log.targetType}
                          </Badge>
